...
export const TH = {
  ...
  "Money you send to your family. Not scored — every published giving statistic this page ranks you against counts donations to organisations and formal volunteering, and none of them asks about supporting your parents. Ranking you on a measure the population was never asked about would be inventing the comparison. It is shown here because it is giving, whatever those surveys count.":
    "เงินที่คุณส่งให้ครอบครัว ไม่นำไปคิดคะแนน เพราะสถิติการให้ที่เผยแพร่ทุกชุดที่หน้านี้ใช้จัดอันดับคุณ นับเฉพาะการบริจาคให้องค์กรและการเป็นอาสาสมัครอย่างเป็นทางการ ไม่มีชุดใดถามถึงการดูแลพ่อแม่ การจัดอันดับคุณด้วยมาตรวัดที่ไม่เคยถามประชากรกลุ่มนั้นเลย เท่ากับเป็นการสร้างการเปรียบเทียบขึ้นมาเอง ค่านี้แสดงไว้ตรงนี้เพราะมันคือการให้ ไม่ว่าแบบสำรวจเหล่านั้นจะนับหรือไม่",
  ...
  "CIT Learning": "แบบวัดการเรียนรู้ CIT",
  // Item 1 is a fact about yesterday, not an attitude — kept concrete, because
  // it is the item the CIT's own seven-country test had to free, and a
  // paraphrase toward "I like learning" would blur it into item 2.
  "I learned something new yesterday": "เมื่อวานฉันได้เรียนรู้สิ่งใหม่",
  "Learning new things is important to me": "การเรียนรู้สิ่งใหม่เป็นเรื่องสำคัญสำหรับฉัน",
  "I always learn something everyday": "ฉันได้เรียนรู้บางสิ่งทุกวันเสมอ",
  ...
  "Monthly saving": "เงินออมต่อเดือน",
  "{thb} THB/mo": "{thb} บาท/เดือน",
  "{rate}% of your income. Not scored — the CFPB questions already ask whether you have money left over at the end of the month, and no published source says what savings rate is good enough to count.": "{rate}% ของรายได้คุณ ไม่คิดคะแนน — คำถาม CFPB ถามอยู่แล้วว่าคุณมีเงินเหลือสิ้นเดือนหรือไม่ และยังไม่มีแหล่งอ้างอิงใดกำหนดว่าอัตราการออมเท่าไหร่จึงจะดีพอ",
  ...
  "Giving": "การให้",
  "{thb} THB/month (500+/mo, or 2% of income, maxes this)": "{thb} บาท/เดือน (500 บาท/เดือน หรือ 2% ของรายได้ ได้เต็ม)",
  ...
  "donates and volunteers — inside the 24% of Thais who volunteer": "ทั้งบริจาคและอาสา — อยู่ในกลุ่ม 24% ของคนไทยที่ทำงานอาสา",
  "volunteers — inside the 24% of Thais who volunteer": "ทำงานอาสา — อยู่ในกลุ่ม 24% ของคนไทยที่ทำงานอาสา",
  "donates — inside the 67% of Thais who gave money": "บริจาค — อยู่ในกลุ่ม 67% ของคนไทยที่บริจาคเงิน",
